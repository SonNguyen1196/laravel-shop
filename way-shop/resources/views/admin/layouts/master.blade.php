...
<!-- Mirrored from admincast.com/adminca/preview/admin_1/html/invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Mar 2020 08:53:33 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="scroller">
                    <div class="media-list">
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('admin-assets')}}//img/users/u3.jpg" alt="image" width="40" />
                            </div>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('admin-assets')}}//img/users/u8.jpg" alt="image" width="40" />
                            </div>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('admin-assets')}}//img/users/u2.jpg" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('admin-assets')}}//img/users/u5.jpg" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('admin-assets')}}//img/users/u6.jpg" alt="image" width="40" />
                            </div>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('admin-assets')}}//img/users/u11.jpg" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('admin-assets')}}//img/users/u9.jpg" alt="image" width="40" />
                            </div>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('admin-assets')}}//img/users/u1.jpg" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('admin-assets')}}//img/users/u10.jpg" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('admin-assets')}}//img/users/u7.jpg" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                    ...
                    <div class="scroller">
                        <div class="messenger-message">
                            <div class="message-image">
                                <img src="{{asset('admin-assets')}}//img/users/u8.jpg" alt="image" />
                            </div>
                        ...
                        <div class="messenger-message">
                            ...
                            <div class="message-body">
                                ...
                                <div class="mb-3">
                                    <img src="{{asset('admin-assets')}}//img/blog/culinary-1.jpg" alt="image" />
                                </div>
                                <div>
                                    <img src="{{asset('admin-assets')}}//img/blog/01.jpg" alt="image" />
                                </div>
                            </div>
                        </div>
                        <div class="messenger-message messenger-message-answer">
